...
<!-- version: 1.1.0 -->
<!-- guid: c9d0e1f2-a3b4-5678-c456-789012345678 -->
...
- All changes to Go release logic should be made in the embedded Python script within action.yml.
...
This repository provides a composite GitHub Action that builds and releases Go applications using GoReleaser.
